...
A step-by-step video of the install process is in the works and will be embedded here.

<VideoPlaceholder
  title="Installing solyto on a fresh server"
  description="Point your domains at the server, run the setup script, and start the stack."
  duration="~10 min"
/>
